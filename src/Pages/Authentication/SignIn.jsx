        ...
        <div className="sc-bWJUgm Bivzm d-md-flex p-0" width="1440">
          <div className="sc-fatcLD fTzblS mx-4 mx-md-auto">
                  ...
                  <>
                    <div className="sc-cgjDci foxhct black-text p-3 mb-4">
                      <div className="d-flex align-items-center">
                        ...
                        <p className="sc-jXbUNg kFsvSZ ml-3">
                          Your account is not yet approved. Please wait for
                          approval from the administrator. Once your account is
                          approved, you'll receive a confirmation email on{" "}
                          <span className="font-weight-600">
                            {formInputs.emailInput}
                          </span>{" "}
                          to be able to proceed with the requested action.
                        </p>
                      </div>
                    </div>
                  </>
            ...
            <p className="sc-jXbUNg kFsvSZ form text-center grey-2-text d-block px-md-3 mb-2">
              ...
              <a target="terms" className="default-text" href="#">
                Terms of use
              </a>
              ,
              <a target="privacy" className="default-text" href="#">
                Privacy Policy
              </a>
              , and
              <a target="standards" className="default-text" href="#">
                Community Standards
              </a>{" "}
              of Mentor.rw.
            </p>
