      ...
      <div className="Layout__Wrapper-sc-2tn75p-0 fBYEGj">
        <div width="1440" className="sc-bddgXz ejKczW container">
          ...
          <div className="CoverPicture__Wrapper-sc-d03l4u-0 xttQm">
            <img src={CoverImage} className="h-100 w-100 img-fit" alt="Cover" />
          </div>
            ...
            <div className="Member__Wrapper-sc-7ba904-0 bCxVyC">
              <div className="ProfilePhoto__Wrapper-sc-1h7ebjw-1 bylpUd">
                <div className="ProfilePhoto__Picture-sc-1h7ebjw-0 ekArRz">
                  <img src={ProfileImage} className="img-fit w-100 h-100" />
              ...
              <div className="InfoAndActions__Wrapper-sc-2sav9c-2 dTmJfN">
                <div className="InfoAndActions__Name-sc-2sav9c-0 fNsuqv">
                  <h2 className="sc-fqkvVR jcuFgw flex-wrap mb-1">
                    <span className="mr-1">Kalisa Patrick</span>
                    <span role="img" aria-label="Rwanda" title="Rwanda">
                      🇷🇼
                    </span>
                  </h2>
                  <p className="sc-gsFSXq fJiOdH name__role">
                    Software engineer<span className="grey-2-text"> at </span>{" "}
                    Google
                  </p>
            ...
            <div className="sc-fUnMCh epgYHv">
              ...
              >
                ...
                <a
                  href="#"
                  role="tab"
                  data-rb-event-key="commendations"
                  aria-selected="false"
            ...
            <div className="Layout__Wrapper-sc-1js8544-0 oKXVt">
              <div style={{ marginBottom: "8rem" }}>
                <div className="line-height-16 mb-3">
                  ...
                  >
                    <p>
                      Remember, this is your intro to your potential mentees!
                      Let your personality shine, while letting them know about
                      your hands-on experience and what you can help them with.
                    </p>
                  </div>
                </div>
                <div className="mt-4">
                  <p className="grey-2-text mb-2">Social links</p>
                  <div className="About__Social-sc-tmc6zy-1 lbfmew mb-4">
                    <a
                      href="https://linkedin.com/in/justinheckel"
                    ...
                    <a href="#" className="social__item d-flex">
                      <svg
                        fill="#000000"
                        width="19"
                        height="18"
		...
		C307.394,57.037,305.009,56.486,302.973,57.388z"
                ...
                <div className="ExpertiseAndLang__Wrapper-sc-1ltorum-1 xYlXD">
                  <div>
                    <p className="grey-2-text mb-2">Expertise</p>
                ...
                <div className="Education__Wrapper-sc-1sff8h1-0 hxJkNP">
                  <div>
                    <div className="section-header d-flex justify-content-between align-items-center">
                      <p className="sc-gsFSXq fJiOdH font-weight-700">
                        Education
                ...
                <div className="Achievements__Wrapper-sc-e3oyuc-2 bezUge"></div>
              </div>
              <div className="p-1">
                <div className="sc-fThUAz dhMxzl">
                  <div className="accordion">
                    ...
                    <div className="sc-fPXMVe dwWqoz"></div>
                    <div className="mt-4 collapse">
                      ...
                      <div className="mb-4 d-flex">
                        ...
                        <p className="sc-kAyceB cCBfKf grey-6-text">
                          <s>Add your past work experiences</s>
                        </p>
                      </div>
                      <div className="mb-4 d-flex">
                        <div className="mr-2">
