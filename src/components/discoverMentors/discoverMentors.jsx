                ...
                <div className="active carousel-item">
                  <div className="Mentors__Grid-sc-uiznoc-1 epLwlm">
                    ...
                    <a
                      className="sc-dBmzty dGxpIk text-decoration-none"
                      target="_blank"
                      href="/mentors/mohd-faizan-siddiqi"
                    >
                      <div className="mentor-avatar overflow-hidden">
                        <div className="image-dimmer"></div>
                        <div className="available-asap position-absolute">
                          ...
                          <span className="ml-1 font-weight-600">
                            Available ASAP
                          </span>
                        </div>
                        <img
                ...
                <div className="carousel-item">
                  <div className="Mentors__Grid-sc-uiznoc-1 epLwlm">
                    ...
                    >
                      ...
                      <div className="sc-eldPxv bJvagg mb-4" width="1440">
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <p className="sc-jXbUNg kFsvSZ grey-1-text">
                            0 sessions{" "}
                            <span className="grey-2-text">(0 reviews)</span>
                          </p>
                        </div>
                      </div>
                      <div className="preview__content__metadata grey-4-bg p-3 mt-auto d-flex justify-content-between">
                    ...
                    <a
                      className="sc-dBmzty dGxpIk text-decoration-none"
                      target="_blank"
                      href="/mentors/victoria-lorenzana"
                    >
                      <div className="mentor-avatar overflow-hidden">
                        <div className="image-dimmer"></div>
                        <img
